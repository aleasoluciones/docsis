...
{ 510,    "ExtendedCMTSMICConfiguration",      6,      130,    (encode_nothing),        (decode_aggregate),      0,           0             }, /* TLV 43.6 */
{ 511,    "ExtendedCMTSMICHMACDigestType",     1,      510,    (encode_hexstr),         (decode_hexstr),         0,           0xFF          }, /* TLV 43.6.1 */
{ 512,    "ExtendedCMTSMICHMACBitmap",         2,      510,    (encode_hexstr),         (decode_hexstr),         0,           0             }, /* TLV 43.6.2 */
{ 513,    "ExtendedCMTSMICHMACDigest",         3,      510,    (encode_hexstr),         (decode_hexstr),         0,           0             }, /* TLV 43.6.3 */
